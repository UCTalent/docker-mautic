...
RUN cd /opt/mautic && \
    COMPOSER_ALLOW_SUPERUSER=1 COMPOSER_PROCESS_TIMEOUT=10000 composer config repositories.uctalent/mautic-pipedrive-bundle vcs https://github.com/uctalent/mautic-pipedrive-bundle.git && \
    COMPOSER_ALLOW_SUPERUSER=1 COMPOSER_PROCESS_TIMEOUT=10000 composer require webmecanik/mautic-pipedrive-bundle:dev-master
